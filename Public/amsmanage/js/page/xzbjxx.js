    ...
    **/
    function validateClassName(domId)
    {
        ...
        $.ajax({
            url:"/Amscontrol/Amsclasslist/checkClassName",
            type:"get",
            dataType:"json",
            data:param,
...
var classTable={
    ...
    addData:function(clsVal, teaVal){
        ...
        var clsText=$("select[@id='"+this.classSel+"'] option[@selected]").text();
        var teaText=$("select[@id='"+this.teachSel+"'] option[@selected]").text();
