function sendCommentBox(sendOptions){
	...
	login_account = sendOptions.login_account || '';
	photo_id = sendOptions.photo_id || '';
	add_uid = login_account || '';
	up_id = sendOptions.up_id || '';
	paramData = {"photo_id":photo_id,"add_uid":login_account,"up_id":up_id};
