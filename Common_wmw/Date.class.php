...
class Date {
     ...
     * @return Date
     +----------------------------------------------------------
     */
    public function firstDayOfQuarter($quarter = 0, $date = '') {
		...
		if (!$quarter) $quarter = $this->getQuarter();        
     ...
     * @return Date
     +----------------------------------------------------------
     */
    public function lastDayOfQuarter($quarter = 0, $date = '') {
	...
	public static function formatedateparams($the_time){
