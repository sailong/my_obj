...
CREATE TABLE IF NOT EXISTS `wmw_feed_timeline` (
  ...
  `from_class_code` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `client_account` (`client_account`),
  KEY `from_class_code` (`from_class_code`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='动态时间线表' AUTO_INCREMENT=1 ;
