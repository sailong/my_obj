<?php
class ClassphotouploadAction extends SnsController {
    ...
    public function index() {
        ...
        $album_id = $this->objInput->postStr('album_id');
        $account = $this->objInput->postStr('client_account');
        ...
        if(!empty($img_arr)) {
            ...
            $add_rs = $PhotoInfo->addPhoto($data);
        }
